...
('antecedentes.pdf', '992333745', '76544322', '2020-04-09', '7563322', 'www.facebook.com/2C', 1);
...
VALUES
('Llanos', 'Perez', 1, 'Lima', 'Av. Zucre 333', 'Magdalena del Mar', 'qgWjsyendiAdnw.jpg', 'César Alejandro', 
'Lima', 1, 1, 0);
...
INSERT INTO Servicio(costo_servicio, descripcion, esta_habilitado, fecha_publicacion,imagen,modalidad,titulo,valoracion,video_presentacion,anunciante_id,tipo_servicio_id)
VALUES (60.00,"Te paseo a tu igüana",1, curdate(), "dsgfsadgds.jpg",1, "Servicio 5", 0.0, "asdgsadgsad.mp4", 2,1);
INSERT INTO Servicio(costo_servicio, descripcion, esta_habilitado, fecha_publicacion,imagen,modalidad,titulo,valoracion,video_presentacion,anunciante_id,tipo_servicio_id)
VALUES (60.00,"Te paseo a tu igüana",1, curdate(), "dsgfsadgds.jpg",1, "Servicio 6", 0.0, "asdgsadgsad.mp4", 1,1);
INSERT INTO Servicio(costo_servicio, descripcion, esta_habilitado, fecha_publicacion,imagen,modalidad,titulo,valoracion,video_presentacion,anunciante_id,tipo_servicio_id)
VALUES (60.00,"Te paseo a tu igüana",1, curdate(), "dsgfsadgds.jpg",1, "Servicio 7", 0.0, "asdgsadgsad.mp4", 1,1);
INSERT INTO Servicio(costo_servicio, descripcion, esta_habilitado, fecha_publicacion,imagen,modalidad,titulo,valoracion,video_presentacion,anunciante_id,tipo_servicio_id)
...
INSERT INTO horario(dia,hora_apertura,hora_cierre,servicio_id) VALUES("Martes", "7:00:00", "21:00:00", 1);
INSERT INTO horario(dia,hora_apertura,hora_cierre,servicio_id) VALUES("Miercoles", "7:00:00", "21:00:00", 1);
INSERT INTO horario(dia,hora_apertura,hora_cierre,servicio_id) VALUES("Jueves", "7:00:00", "21:00:00", 1);
INSERT INTO horario(dia,hora_apertura,hora_cierre,servicio_id) VALUES("Viernes", "7:00:00", "21:00:00", 1);
